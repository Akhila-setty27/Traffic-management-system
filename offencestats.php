...
<body>
    <div class="wrapper">
        ...
        <div id="content">
                ...
                <div class="container-fluid">
                    <div>
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="offencestats.php">Statistics by Offences</a></li>
                            <li class="nav-item"><a class="nav-link" href="searchlic.php">Search using Civilian License
                                    No</a></li>
            ...
            <div class="view">
                <form method="POST">
                    <h3>Enter the Offence</h3>
                    <input type="text" name="offence" size="30" class="input_form"
                ...
                <table class="table">
                    ...
                    <div class="Display">
                        ...
                        $sql = "SELECT offence, fine, vehicleno, place, datetime,licenseno FROM useroffence WHERE offence LIKE '%$offence%'" ;
                        $sum = "SELECT SUM(fine),COUNT(offence) from useroffence where offence = '$offence'";
